...
export const CornerBottomLeftIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
CornerBottomLeftIconIcon.propTypes = {iconType: PropTypes.string};
CornerBottomLeftIconIcon.defaultProps = {iconType: 'Corners'};

export default CornerBottomLeftIconIcon;