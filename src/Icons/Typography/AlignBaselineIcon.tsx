...
export const AlignBaselineIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
AlignBaselineIconIcon.propTypes = {iconType: PropTypes.string};
AlignBaselineIconIcon.defaultProps = {iconType: 'Typography'};

export default AlignBaselineIconIcon;