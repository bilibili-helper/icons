...
export const QuoteIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
QuoteIconIcon.propTypes = {iconType: PropTypes.string};
QuoteIconIcon.defaultProps = {iconType: 'Components'};

export default QuoteIconIcon;