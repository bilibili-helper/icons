...
export const PlayFilledIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
PlayFilledIconIcon.propTypes = {iconType: PropTypes.string};
PlayFilledIconIcon.defaultProps = {iconType: 'Player'};

export default PlayFilledIconIcon;