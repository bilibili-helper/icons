...
SpeakerModerateIcon.displayName = 'SpeakerModerateIcon';
SpeakerModerateIcon.propTypes = {iconType: PropTypes.string};
SpeakerModerateIcon.defaultProps = {iconType: 'Player'};