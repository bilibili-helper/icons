...
export const IconJarLogoIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
IconJarLogoIconIcon.propTypes = {iconType: PropTypes.string};
IconJarLogoIconIcon.defaultProps = {iconType: 'Logos'};

export default IconJarLogoIconIcon;