...
export const MoonIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
MoonIconIcon.propTypes = {iconType: PropTypes.string};
MoonIconIcon.defaultProps = {iconType: 'Objects'};

export default MoonIconIcon;