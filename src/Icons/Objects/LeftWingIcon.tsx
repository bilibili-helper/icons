...
export const LeftWingIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
LeftWingIconIcon.propTypes = {iconType: PropTypes.string};
LeftWingIconIcon.defaultProps = {iconType: 'Objects'};

export default LeftWingIconIcon;