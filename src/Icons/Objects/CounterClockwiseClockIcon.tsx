...
export const CounterClockwiseClockIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
CounterClockwiseClockIconIcon.propTypes = {iconType: PropTypes.string};
CounterClockwiseClockIconIcon.defaultProps = {iconType: 'Objects'};

export default CounterClockwiseClockIconIcon;