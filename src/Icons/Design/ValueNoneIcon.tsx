...
export const ValueNoneIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
ValueNoneIconIcon.propTypes = {iconType: PropTypes.string};
ValueNoneIconIcon.defaultProps = {iconType: 'Design'};

export default ValueNoneIconIcon;