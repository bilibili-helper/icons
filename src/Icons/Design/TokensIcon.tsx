...
export const TokensIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
TokensIconIcon.propTypes = {iconType: PropTypes.string};
TokensIconIcon.defaultProps = {iconType: 'Design'};

export default TokensIconIcon;