...
export const CursorTextIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
CursorTextIconIcon.propTypes = {iconType: PropTypes.string};
CursorTextIconIcon.defaultProps = {iconType: 'Design'};

export default CursorTextIconIcon;