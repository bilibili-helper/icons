...
export const AlignLeftIconIcon = React.forwardRef<SVGSVGElement, IconProps>(
...
AlignLeftIconIcon.propTypes = {iconType: PropTypes.string};
AlignLeftIconIcon.defaultProps = {iconType: 'Alignment'};

export default AlignLeftIconIcon;